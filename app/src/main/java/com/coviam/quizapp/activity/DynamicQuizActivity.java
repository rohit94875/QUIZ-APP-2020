...
//                            }
                            ...
                            Toast.makeText(DynamicQuizActivity.this,"Can't skip more than three questions",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
...
//                        }
            ...
            public void onFailure(Call<List<QuestionDTO>> call, Throwable t) {
                loadbar.setVisibility(View.GONE);
                Toast.makeText(DynamicQuizActivity.this,"server error",Toast.LENGTH_SHORT).show();
        ...
        apiInterface.submitAnswers(answerDTO).enqueue(new Callback<com.coviam.quizapp.pojo.Response>() {
            ...
            public void onResponse(Call<com.coviam.quizapp.pojo.Response> call, Response<com.coviam.quizapp.pojo.Response> response) {
                if(response.body().isStatus()){
                    Toast.makeText(DynamicQuizActivity.this,"success",Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(DynamicQuizActivity.this,"fail",Toast.LENGTH_SHORT).show();
    ...
    private void showNextQuestion() {
        if(counter<numberOfQuestions){
            ...
            Intent intent=new Intent(DynamicQuizActivity.this,DummyActivity.class);
    ...
    void setValues(QuestionDTO questionDTO){
        ...
        switch (questionDTO.getQuestionFormat()){
            ...
            case "image":
                ...
                questionView.setVisibility(View.GONE);
                Glide.with(DynamicQuizActivity.this).load(questionDTO.getUrlAttachment()).into(questionImage);
                break;
            case "video":
                questionImage.setVisibility(View.GONE);
    ...
    void callAdd(){
        Intent intent=new Intent(DynamicQuizActivity.this,AdActivity.class);
        startActivity(intent);
